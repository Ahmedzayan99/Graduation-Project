...
import 'package:blackgym/cubit/exercises/exercises_cubit.dart';
import 'package:blackgym/data/models/plan/plan.dart';
import 'package:conditional_builder_null_safety/conditional_builder_null_safety.dart';
import 'package:flutter/material.dart';

import '../../../cubit/exercises/exercises_states.dart';
import '../../../shared/components/components.dart';
import '../start_training.dart';
                ...
                ConditionalBuilder(
                  ...
                  builder: (context)=>Container(
                    ...
                    child: MaterialButton(
                      onPressed: () {
                        ExercisesCubit.get(context).getOnlyMuscles1(id: cubit.musclesModel!.data![index].id);
                        Navigator.push(
                          context,
                          MaterialPageRoute(
