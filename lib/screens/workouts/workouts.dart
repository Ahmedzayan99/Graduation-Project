...
import 'package:blackgym/screens/workouts/widgets/rate_user_widget.dart';
...
import '../../cubit/workouts/workouts_states.dart';
import '../../shared/components/components.dart';
import '../../shared/styles/colors_manager.dart';
import '../../shared/styles/iconly_broken.dart';
import '../exercises/widgets/plan_exercises_widget.dart';
...
class _WorkoutsScreenState extends State<WorkoutsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<WorkoutsCubit,WorkoutsStates>(
      listener: (context, state) {
      },
      builder: (context, state) {
        var cubit = WorkoutsCubit.get(context);
        var planModel =cubit.planlModel;
       var   userModel= SettingsCubit.get(context).userModel! != null && SettingsCubit.get(context).userModel!.users! !=null&&SettingsCubit.get(context).userModel!.users!.rate![0]!=null?SettingsCubit.get(context).userModel!.users!.rate![0]:null;
