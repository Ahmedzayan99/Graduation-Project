            ...
            return BlocConsumer<NotesCubit,NotesStates>(
              ...
              builder: (context, state) {
                return Scaffold(
                  ...
                  body:NotesCubit.get(context).task! !=null?NewNotesScreen():Center(
                    child: Column(
                  ...
                  floatingActionButton: FloatingActionButton(
                    ...
                    onPressed: () {
                      if (NotesCubit.get(context).isBottomSheet ) {
                        if (formKey.currentState!.validate()) {
                          NotesCubit.get(context).createNotes(
                        ...
                        {
                          NotesCubit.get(context).changeBottomSheetState(
                              isShow:false ,
                    ...
                    child: Icon(NotesCubit.get(context).iconShow,color: ColorsManager.black),),
                );
              },
...
//_____________start build Widget____________________________________________________________
  ...
  Widget build(BuildContext context)
  {
    ...
    return BlocConsumer<NotesCubit,NotesStates>(
      ...
      builder: (context, state) {
        NotesCubit Notesit = NotesCubit.Notes(context);
        return Scaffold(
          key: scaffoldKey,
          // ------appBer -------  .listen((event) {
